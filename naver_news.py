...
def score_importance(title: str, content_snippet: str) -> int:
    """
    기사 중요도를 1~3점으로 평가.
    3: 업계 전반에 영향을 미치는 중대 사건
       (정책/규제, 메모리 3사·빅테크 대규모 투자·M&A, 공급망 위기, 실적 충격)
    2: 주목할 만한 뉴스
       (메모리 신제품/신기술, 메모리 3사·빅테크 목표주가 변화)
    1: 일반 뉴스
       (비메모리 3사 지엽적 뉴스, 인사·채용·마케팅, 단순 반복 보도)
    """
    prompt = (
        "다음 반도체 관련 기사의 중요도를 1~3점으로만 평가하세요.\n\n"
        "3점 기준: 업계 전반에 영향을 미치는 중대 사건\n"
        "  - 메모리 3사(삼성전자/SK하이닉스/마이크론), 미국 빅테크의 대규모 공장 투자, M&A, 사업 철수\n"
        "  - 삼성전자 목표주가 변화, 미국 빅테크의 대규모 공장 투자, M&A, 사업 철수\n"
        "  - 공급망 위기 (소재·장비 수출금지, 재해)\n"
        "  - 시장 예상을 크게 벗어난 실적\n\n"
        "  - 메모리 시장에 대한 부정적인 전망\n\n"
        "2점 기준: 주목할 만한 뉴스\n"
        "  - 시장 전망 또는 SK하이닉스, 마이크론 및 미국 빅테크 목표주가 변화\n\n"
        "  - 정부 정책/수출규제/보조금 확정\n"
        "1점 기준: 일반적인 뉴스\n"
